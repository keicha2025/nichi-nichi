...
export const StatsPage = {
    ...
    <section class="space-y-6 py-4 animate-in fade-in pb-10">
        ...
        <div class="bg-white p-6 rounded-[2rem] muji-shadow border border-bdr-subtle space-y-6">
            <!-- 1. 頂部控制列 (Reordered) -->
            <div class="flex bg-bg-subtle rounded-xl p-1 mb-2">
                ...
                <div v-show="filterMode === 'normal'" class="flex flex-col space-y-2">
                   ...
                   <div class="flex flex-wrap items-center gap-x-4 gap-y-2 px-1 pt-1">
                       ...
                       <div class="flex items-center space-x-2">
                           <div @click="isMyShareOnly = !isMyShareOnly" class="w-4 h-4 rounded border flex items-center justify-center transition-colors cursor-pointer" :class="isMyShareOnly ? 'bg-gray-700 border-gray-700' : 'bg-white border-bdr-default'">
                       ...
                       <!-- 排除專案選項 -->
                       <div class="flex items-center space-x-2">
                           <div @click="excludeProjects = !excludeProjects" class="w-4 h-4 rounded border flex items-center justify-center transition-colors cursor-pointer" :class="excludeProjects ? 'bg-gray-700 border-gray-700' : 'bg-white border-bdr-default'">
        ...
        <!-- 2. 圖表區域 -->
        <div @click="resetChartSelection" class="bg-white p-8 rounded-[2rem] muji-shadow border border-bdr-subtle cursor-pointer">
            <h3 class="text-[10px] text-txt-secondary uppercase tracking-widest font-medium mb-8 text-center">Category Distribution</h3>
        ...
        <!-- 3. 支付方式 -->
        <div class="bg-white p-6 rounded-[2rem] muji-shadow border border-bdr-subtle space-y-5">
