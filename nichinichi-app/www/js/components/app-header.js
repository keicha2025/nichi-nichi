export const AppHeader = {
    ...
    <header class="w-full max-w-md mx-auto px-4 pt-6 pb-3 flex justify-between items-center border-b border-bdr-subtle/50">
        ...
        <div class="flex items-center space-x-2">
            ...
            <div v-if="syncStatus === 'syncing'" class="flex items-center space-x-1 bg-bg-subtle px-3 py-1.5 rounded-full animate-pulse">
                <span class="material-symbols-rounded text-[10px] text-action-primary-bg animate-spin">sync</span>
                <span class="text-[9px] font-bold text-action-primary-bg tracking-wider">SYNCING</span>
            </div>
