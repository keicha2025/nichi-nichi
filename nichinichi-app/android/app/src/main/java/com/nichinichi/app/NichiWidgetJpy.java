...
public class NichiWidgetJpy extends AppWidgetProvider {

    private static final String PREFS_NAME = "CapacitorStorage";
    private static final String KEY_TODAY_TOTAL = "today_total_jpy";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("com.nichinichi.app.UPDATE_WIDGET".equals(intent.getAction())) {
            ...
            ComponentName thisAppWidget = new ComponentName(context.getPackageName(), NichiWidgetJpy.class.getName());
