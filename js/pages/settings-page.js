...
export const SettingsPage = {
    ...
    <section class="space-y-4 py-4 animate-in fade-in pb-24">
        ...
        <div v-if="appMode !== 'GUEST'" class="pt-8 pb-12 flex justify-start px-2">
            <button @click="navigateToGuide" class="text-[10px] text-txt-muted hover:text-txt-secondary tracking-[0.2em] uppercase font-medium">
                使用指南
            </button>
        </div>
    </section>
