...
export const EditPage = {
        ...
        <div class="bg-white p-6 rounded-[2.5rem] muji-shadow border border-gray-50 space-y-6">
            ...
            <div class="text-center py-2 flex flex-col items-center justify-center">
                ...
                <div v-if="isReadOnly" class="text-5xl font-light text-gray-700">
                    <span class="text-xl mr-1">{{ getCurrencySymbol(form.currency) }}</span>{{ formatNumber(form.amount) }}
                </div>
                ...
                <div v-if="!isReadOnly && showPreview" class="mt-2 text-xs text-gray-400 font-light flex items-center space-x-1 animate-in fade-in">
                    <span class="material-symbols-rounded text-[10px]">swap_horiz</span>
                    <span>≈ {{ previewAmount }}</span>
                </div>
                <!-- ReadOnly Preview -->
                <div v-if="isReadOnly && showPreview" class="mt-1 text-xs text-gray-400">
                    (≈ {{ previewAmount }})
                </div>
            </div>
                ...
                <div v-if="form.type === '支出'" class="pt-4 border-t border-gray-50 space-y-4">
                    ...
                    <div v-if="form.isSplit" class="bg-gray-50 p-6 rounded-3xl space-y-6 mx-2">
                        ...
                        <div class="flex justify-between items-center pt-2 border-t border-gray-100">
                            ...
                            <span v-else class="text-sm font-medium">¥ {{ formatNumber(splitMode === 'auto' ? autoShareValue : (form.personalShare || 0)) }}</span>
                        </div>
    ...
    computed: {
        ...
        showPreview() {
            return this.form.amount > 0 && this.form.currency !== this.baseCurrency.value;
        },
        previewAmount() {
